...
*
* Original Code by Ulrich Drepper <drepper@gnu.ai.mit.edu>, 1995.
*
* Modified by Gary Wong, 2000, 2001.
*
* Modified by Lisa Milne, 2010.
*
* Functions to compute MD5 message digest of files or memory blocks.
* according to the definition of MD5 in RFC 1321 from April 1992.
* Copyright (C) 1995, 1996, 1997, 1999, 2000, 2010 Free Software
* Foundation, Inc.
*
* md5.c is free software: you can redistribute it and/or modify it
* under the terms of the GNU General Public License as published by the
* Free Software Foundation, either version 3 of the License, or
* (at your option) any later version.
*
* md5.c is distributed in the hope that it will be useful, but
...
/* #define FF(b, c, d) ((b & c) | (https://pastee.org/sz99g~b & d)) */
